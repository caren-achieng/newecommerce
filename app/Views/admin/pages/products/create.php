			...
			<section class="content">
				<div class="container-fluid">
					...
					<div class="card">
						...
						<div class="card-body">
							<form class="g-3" id="category" method="post" action="" enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-6">
										<label for="category_name" class="form-label">Category</label>
										<select id="inputState" class="form-select" name="category" required
										        onchange="addSubcategories(value);">
									...
									<div class="col-md-6">
										...
										<select id="subcategory" class="form-select" name="subcategory_id" required>
											<option value="" disabled selected>Choose...</option>
										</select>
									</div>
								</div>
								...
								<div class="row mt-3 mb-3 col-12">
									<label for="prod_description" class="col-sm-2 col-form-label">Product
										Description</label>
									<div class="col-sm-10">
									<textarea class="form-control" name="prod_description"
