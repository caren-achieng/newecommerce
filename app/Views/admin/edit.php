...
<div class=" position-absolute form">
    ...
    <?php endif;?>
    <form id="register" class="row g-3" style="max-width: 500px" method="post" action="<?= base_url('client/update/'.$client['user_id'])?>">
        <div class="row">
            <div class="col-12 text-white">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" name="email" autocomplete="off" required value="<?= $client['email'] ?>">
            </div>
            <div class="col-md-6 text-white">
                <label for="firstname" class="form-label">First Name</label>
                <input type="text" class="form-control" name="first_name" autocomplete="off" required value="<?= $client['first_name'] ?>">
            </div>
            <div class="col-md-6 text-white">
                <label for="firstname" class="form-label">Last Name</label>
                <input type="text" class="form-control" name="last_name" autocomplete="off" required value="<?= $client['last_name'] ?>">
            </div>
            <div class="col-md-6 text-white">
